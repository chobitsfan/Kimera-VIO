...
#include "KimeraRos2NodeOffline.h"
...
class Ros2Display : public VIO::DisplayBase {
    public:
        ...
        Ros2Display(std::shared_ptr<KimeraRos2NodeOffline> ros2_node) : VIO::DisplayBase(VIO::DisplayType::kOpenCV), ros2_node_(ros2_node) {}
        ...
        */
        void spinOnce(VIO::DisplayInputBase::UniquePtr&& viz_output) override {
            ...
            for (const VIO::ImageToDisplay& img_to_display : viz_output->images_to_display_) {
                ...
                // ros2_node_->img_pub->publish(img_msg);
                ros2_node_->getImgPub()->publish(img_msg);
            }
        }
    private:
        std::shared_ptr<KimeraRos2NodeOffline> ros2_node_;
};

KimeraRos2NodeOffline::KimeraRos2NodeOffline() : KimeraRos2NodeCommon("kimera_vio")  {
// KimeraRos2NodeOffline::KimeraRos2NodeOffline() : Node("kimera_vio") {
...
int main(int argc, char* argv[]) {
  ...
  auto ros_node = std::make_shared<KimeraRos2NodeOffline>();
